...
Creates client information for other functions. Just for internal use.
=======================================================================================================================================
*/
...
Catches server command. clientNum => Client ID(from 0 to MAX_CLIENTS), msg => Message sends by backend.
=======================================================================================================================================
*/
...
Get guid for stats. We prefer to use original cl_guid, but some mods has their own guid values.
=======================================================================================================================================
*/
char *Tracker_getGUID(client_t *cl) {
