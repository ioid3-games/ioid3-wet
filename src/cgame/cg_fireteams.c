...
panel_button_text_t fireteamFont = {
	0.2f,   0.2f, {0.6f, 0.6f, 0.6f, 1.f}, ITEM_TEXTSTYLE_SHADOWED, 0, &cgs.media.limboFont2,
};

panel_button_t fireteamTopBorder = {
	NULL, NULL, {10, 129, 204, 136}, {1,  255 * .5f, 255 * .5f, 255 * .5f, 255 * .5f, 1, 0, 0}, NULL, /* font     */
	NULL, /* keyDown  */
	NULL, /* keyUp    */
...
panel_button_t fireteamTopBorderBack = {
	"white", NULL, {11, 130, 202, 134}, {1,  0, 0, 0, 255 * 0.75f, 0, 0, 0}, NULL, /* font     */
	NULL, /* keyDown  */
	NULL, /* keyUp    */
	BG_PanelButtonsRender_Img, NULL,
};
...
panel_button_t fireteamTopBorderInner = {
	"white", NULL, {12, 131, 200, 12}, {1,  41, 51, 43, 204, 0, 0, 0}, NULL, /* font     */
	NULL, /* keyDown  */
	NULL, /* keyUp    */
	BG_PanelButtonsRender_Img, NULL,
};
...
panel_button_t fireteamTopBorderInnerText = {
	NULL, NULL, {15,    141, 200, 12}, {0,     0, 0, 0, 0, 0, 0, 0}, &fireteamTitleFont, /* font     */
	NULL,    /* keyDown  */
	NULL,    /* keyUp    */
	CG_Fireteams_MenuTitleText_Draw, NULL,
};

panel_button_t fireteamMenuItemText = {
	NULL, NULL, {16,  153, 128, 12}, {0,   0, 0, 0, 0, 0, 0, 0}, &fireteamFont, /* font     */
	NULL,  /* keyDown  */
	NULL,  /* keyUp    */
	CG_Fireteams_MenuText_Draw, NULL,
};
...
const char *ftMenuRootStrings[] = {
	"Soldier", "Medic", "Engineer", "Field Ops", "Covert Ops", "General", "Attack", "Fall Back", NULL
};
...
const char *ftMenuRootStringsAlphachars[] = {
	"S", "M", "E", "F", "C", "G", "A", "B", NULL
};

const char *ftMenuSoldierStrings[] = {
	"Cover Me", "Covering Fire", "Mortar", NULL
};
...
const char *ftMenuSoldierStringsMsg[] = {
	"FTCoverMe", "FTCoveringFire", "FTMortar", NULL
};

const char *ftMenuMedicStrings[] = {
	"Heal Squad", "Heal Me", "Revive Team Mate", "Revive Me", NULL
};
...
const char *ftMenuMedicStringsMsg[] = {
	"FTHealSquad", "FTHealMe", "FTReviveTeamMate", "FTReviveMe", NULL
};


const char *ftMenuEngineerStrings[] = {
	"Destroy Objective", "Repair Objective", "Construct Objective", "Disarm Dynamite", "Deploy Landmines", "Disarm Landmines", NULL
};
...
const char *ftMenuEngineerStringsMsg[] = {
	"FTDestroyObjective", "FTRepairObjective", "FTConstructObjective", "FTDisarmDynamite", "FTDeployLandmines", "FTDisarmLandmines", NULL
};

const char *ftMenuFieldOpsStrings[] = {
	"Call Air - Strike", "Call Artillery", "Resupply Squad", "Resupply Me", NULL
};
...
const char *ftMenuFieldOpsStringsMsg[] = {
	"FTCallAirStrike", "FTCallArtillery", "FTResupplySquad", "FTResupplyMe", NULL
};

const char *ftMenuCovertOpsStrings[] = {
	"Explore Area", "Destroy Objective", "Infiltrate", "Go Undercover", "Provide Sniper Cover", NULL
};
...
const char *ftMenuCovertOpsStringsMsg[] = {
	"FTExploreArea", "FTSatchelObjective", "FTInfiltrate", "FTGoUndercover", "FTProvideSniperCover", NULL
};

const char **ftMenuStrings[] = {
	ftMenuSoldierStrings, ftMenuMedicStrings, ftMenuEngineerStrings, ftMenuFieldOpsStrings, ftMenuCovertOpsStrings,
};

const char **ftMenuStringsAlphachars[] = {
	ftMenuSoldierStringsAlphachars, ftMenuMedicStringsAlphachars, ftMenuEngineerStringsAlphachars, ftMenuFieldOpsStringsAlphachars, ftMenuCovertOpsStringsAlphachars,
};

const char **ftMenuStringsMsg[] = {
	ftMenuSoldierStringsMsg, ftMenuMedicStringsMsg, ftMenuEngineerStringsMsg, ftMenuFieldOpsStringsMsg, ftMenuCovertOpsStringsMsg,
};
...
const char *ftLeaderMenuList[] = {
	"Disband", "Leave", "Invite", "Kick", "Warn", "Change privacy", "Change admin", NULL,
};
