...
typedef enum {
	...
	FL_FAILED = 0, // couldn't query locale -- returning a guess(almost always English)
	FL_DEFAULT_GUESS = 1, // the returned locale type was found by successfully asking the system
	FL_CONFIDENT = 2
} FL_Success;
