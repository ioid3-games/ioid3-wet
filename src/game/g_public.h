...
typedef enum {
	...
	G_FS_RENAME, G_FS_FCLOSE_FILE, // (fileHandle_t f);
...
//#endif
	...
	G_FS_GETFILELIST, G_DEBUG_POLYGON_CREATE, G_DEBUG_POLYGON_DELETE, G_REAL_TIME, G_SNAPVECTOR,
	...
	// 500
	// files
	BOTLIB_PC_LOAD_SOURCE = 579, BOTLIB_PC_FREE_SOURCE, BOTLIB_PC_READ_TOKEN, BOTLIB_PC_SOURCE_FILE_AND_LINE, BOTLIB_PC_UNREAD_TOKEN,

	PB_STAT_REPORT = 584, // don't remove, vanilla clients might call this

	G_SENDMESSAGE = 585, G_MESSAGESTATUS,
} gameImport_t;
...
typedef enum {
	...
	// BOTAI_START_FRAME, // BOT_VISIBLEFROMPOS, // BOT_CHECKATTACKATPOS,
