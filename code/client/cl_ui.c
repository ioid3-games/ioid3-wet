...
Removes server(s) from the 'cache'. Positive values AS_LOCAL, AS_GLOBAL, AS_FAVORITES or negative values AS_LOCAL_ALL, AS_GLOBAL_ALL,
AS_FAVORITES_ALL to remove all. Server address - in case of negative source param addr is not required.
=======================================================================================================================================
*/
