...
cvar_t *com_crashed = NULL;		// set in case of a crash, prevents CVAR_UNSAFE variables from being set from a cfg, explicit NULL to make win32 teh happy
...
Check for "safe" on the command line, which will skip loading of wolfconfig.cfg.
=======================================================================================================================================
*/
...
Prints key and values of a given String to console.
=======================================================================================================================================
*/
...
// jusy so we can track a block to find out when it's getting trashed
...
memstatic_t emptystring = {{(sizeof(memblock_t) + 2 + 3) & ~3u, TAG_STATIC, NULL, NULL, ZONEID}, {'\0', '\0'}};
...
#endif
	// update the com_hunkused cvar in increments, so we don't update it too often, since this cvar call isn't very efficent
...
int Com_EventLoop(void) {
	...
	while (1) {
		...
		switch (ev.evType) {
			...
			case SE_CHAR:
#ifndef DEDICATED
				// we just pressed the console button, so ignore this event
				// this prevents chars appearing at console input when you just opened it
...
See com_journal. Com_Milliseconds also processes system events.
Returns Sys_Milliseconds (finally).
=======================================================================================================================================
*/
...
Checks if profile.pid is valid. Return qtrue if valid, otherwise qfalse if invalid(!).
=======================================================================================================================================
*/
...
Track profile changes, delete old pid file if we change fs_game (dir).
