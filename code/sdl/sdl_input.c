...
// it's not simulating "the next 1/60th or 1/125th" of a second. If you give it "now" as input timestamps, your inputs do not occur until
// the *next* simulated chunk of time.
...
Check if Num key is lock down. Return qtrue if Num key is lock down, qfalse if not.
=======================================================================================================================================
*/
...
Prints keyboard identifiers in the console.
=======================================================================================================================================
*/
...
Translates SDL keyboard identifier to its Q3 counterpart.
=======================================================================================================================================
*/
		...
		switch (keysym->sym) {
			...
			switch (keysym->scancode) {
				...
				case SDL_SCANCODE_GRAVE:
					key = K_GRAVE; // NOTE: this is console toogle key!
					break;
...
static void IN_DeactivateMouse(void) {
	...
	if (!cls.glconfig.isFullscreen) {
#if 0
		if ((Key_GetCatcher() == KEYCATCH_UI) && screen == SDL_GetMouseFocus()) {
...
/*
=======================================================================================================================================
IN_PrintJoystickInfo_f

Prints joystick info to console.
=======================================================================================================================================
*/
...
Inits game controller input devices. This doesn't deal with SDL_INIT_GAMECONTROLLER.
=======================================================================================================================================
*/
...
static void IN_WindowResize(SDL_Event *e) {
	...
	// only do a vid_restart if the size of the window actually changed. On OS X at least, it's possible to receive a resize event when
	// the window simply moves, or even when Dock shows/hides. No need to do a vid_restart then
